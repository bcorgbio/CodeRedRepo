...
In this project, the force-length relationship of input muscles in the human arm and their response to fatigue will be studied. First, human forearm flexors will undertake maximum voluntary contractions (MVCs) and isometric force-angle curves will be constructed from these data. Next, the angles at which maximum isometric force (Fmax) occur (θmax) between non-fatigued (control) and eccentrically fatigued forearm flexors will be compared. Lastly, the mechanisms underlying the force-length/angle relationship shifts after eccentric fatigue will be discussed.
